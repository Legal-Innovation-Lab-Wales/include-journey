...
class TeamMemberTest < ActiveSupport::TestCase
  ...
  test "team member with empty required fields is invalid" do
    team_member = TeamMember.new first_name: "", last_name: "", email: "", password: "", mobile_number: ""
  ...
  test "team member not accepting terms is invalid" do
    team_member = TeamMember.new first_name: "Clive", last_name: "Doe", email: "clive.doe@example.com", mobile_number: "07567 890123", password: "test1234"

    assert_invalid team_member, :terms
  end

  test "team member with required fields, accepting terms, is valid" do
    team_member = TeamMember.new first_name: "Clive", last_name: "Doe", email: "clive.doe@example.com", mobile_number: "07567 890123", password: "test1234", terms: true
