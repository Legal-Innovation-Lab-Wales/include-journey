...
class SurveyTest < ActiveSupport::TestCase
  ...
  test "should allow survey with valid fields" do
    survey = Survey.new name: "Rate Your Experience", start_date: @start_date, end_date: @end_date, team_member: @team_member
  ...
  test "should not allow survey with start date after end date" do
    ...
    survey = Survey.new name: "Rate Your Experience", start_date: @end_date, end_date: @start_date, team_member: @team_member
