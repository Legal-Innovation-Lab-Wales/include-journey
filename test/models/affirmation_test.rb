...
class AffirmationTest < ActiveSupport::TestCase
  ...
  test "affirmation without required fields is invalid" do
    ...
    assert_invalid affirmation, :team_member_id
  end
  ...
  test "should allow affirmation with valid fields" do
    affirmation = Affirmation.new text: "All is well", scheduled_date: @date, team_member: @team_member
  ...
  test "should not allow multiple affirmations on same date" do
    ...
    Affirmation.create! text: "All is well", scheduled_date: @date, team_member: @team_member

    affirmation = Affirmation.new text: "Everything is fine", scheduled_date: @date, team_member: @team_member
