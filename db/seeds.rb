...
puts("#{pretty_print_name('Occupational Therapist Assessments')}\t#{OccupationalTherapistAssessment.count}")
puts("#{pretty_print_name('Occupational Therapist Metrics')}\t#{OccupationalTherapistMetric.count}")
puts("#{pretty_print_name('Occupational Therapist Scores')}\t#{OccupationalTherapistScore.count}")
puts("#{pretty_print_name('Occupational Therapist Assessment Entries')}\t#{OtaEntry.count}")