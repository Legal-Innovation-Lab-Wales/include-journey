...
puts("#{pretty_print_name('OT Assessments')}\t#{OccupationalTherapistAssessment.count}")
puts("#{pretty_print_name('OT Metrics')}\t#{OccupationalTherapistMetric.count}")
puts("#{pretty_print_name('OT Scores')}\t#{OccupationalTherapistScore.count}")
puts("#{pretty_print_name('OTA Entries')}\t#{OtaEntry.count}")