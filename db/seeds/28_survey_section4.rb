...
if survey.survey_sections.count < 4
  ...
  section4.survey_comment_sections.create!(order: 1, label: 'Please add any feedback about Include UK:')
  section4.survey_comment_sections.create!(
    order: 2,
    label: 'Please add any feedback about other services you have received (excluding Include UK):'
  )
