module TeamMembers
  ...
  class UploadActivityLogsController < ApplicationController
    ...
    def resources
      @team_member.upload_activity_logs.includes(:user, :upload)
                  .joins(:upload)
    end
    ...
    def subheading_stats
      ...
      @rejected_in_last_week = @resources.rejected_in_last_week.size
      @rejected_in_last_month = @resources.rejected_in_last_month.size
    end
