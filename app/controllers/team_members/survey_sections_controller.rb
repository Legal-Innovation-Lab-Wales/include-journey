module TeamMembers
  ...
  class SurveySectionsController < SurveyApplicationController
    ...
    def reorder
      reorder_params[:questions].each_with_index do |id, i|
        order(@survey_section.survey_questions, id, i)
      end
    ...
    def section_params
      params.require(:survey_section)
        .permit(:heading, :answer_labels)
    end

    def reorder_params
      params.require(:survey_section)
        .permit(questions: [], comment_sections: [])
    end
  end
end
