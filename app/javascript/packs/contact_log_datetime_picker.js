const start_date_field = document.querySelector('#contact_log_start_when'),
      start_time_field = document.querySelector('#contact_log_start_time'),
      start_hidden_field = document.querySelector('#contact_log_start'),
      update_start = () => start_hidden_field.value = new Date(`${start_date_field.value} ${start_time_field.value}`),
      end_date_field = document.querySelector('#contact_log_end_when'),
      end_time_field = document.querySelector('#contact_log_end_time'),
      end_hidden_field = document.querySelector('#contact_log_end'),
